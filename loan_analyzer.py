...
print(f"total of all loans: $ {total_of_all_loans: .2f}")
...
print(f"Average loan amount from the list: $ {average_loan_amount: .2f}")
...
#present_value = calculate_present_value(new_loan.get("loan_price"), new_loan.get("remaining_months"), .2)
present_value = calculate_present_value(new_loan.get("future_value"), new_loan.get("remaining_months"), .2)
...
for loan in loans:
    if loan["loan_price"] <= 500:
        ...
        counter = counter + 1
        print(f"Inexpensive loan {counter}: $ {loan}")
...
with open(output_path, 'w', newline='') as csvfile:
    ...
    print("Completed Updating the csv file with the loan values")